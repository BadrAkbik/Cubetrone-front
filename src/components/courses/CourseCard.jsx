    ...
    return (
        <div className="max-w-xs bg-white border border-gray-200 rounded-lg shadow">
            ...
            <div className="p-5">
                ...
                <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white  rounded-lg bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Read more
